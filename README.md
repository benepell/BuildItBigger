...
### PROJECT REVIEW
Great work with the app!, It is very apparent that you have put a lot of effort in getting the app up and running.
In addition to all the required specifications, you went an extra mile and added progress bar and interstitial ads as well.
The app looks great and works as expected.
